    ...
    : IEqualityOperators<Rect, Rect, bool>, IEquatable<Rect>
{
    ...
    /// <summary> The upper-left corner as a <see cref="Native.Point"/> structure. </summary>
    ...
    /// <summary> Gets the dimensions of the rectangle as a <see cref="Native.Size"/>. </summary>
