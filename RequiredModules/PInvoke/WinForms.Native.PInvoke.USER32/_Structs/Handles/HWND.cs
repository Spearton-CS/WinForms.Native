...
public readonly record struct HWND(Handle Handle)
    ...
    IEqualityOperators<HWND, Handle, bool>, IEquatable<Handle>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(HWND left, Handle right) => left.Handle == right;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(HWND left, Handle right) => left.Handle != right;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Handle(HWND hwnd) => hwnd.Handle;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
